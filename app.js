...
const putData = (finalData) => {
    ...
    finalData.map((country) => content.innerHTML +=
        `
    <div class="card bg-dark text-white border-light mb-3 mx-3 my-3" style="width: 18rem;">
        <div class="card-header text-center">
            ${country.alpha2Code}
        </div>
        <img src="${country.flag}" class="card-img-top border border-light">
        <div class="card-body">
            ...
            <p class="card-text">Population: ${country.population}</p>
             <p class="card-text">Latitude,Longitude: ${country.latlng}</p>
